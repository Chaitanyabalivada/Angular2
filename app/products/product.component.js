...
var ProductComponent = /** @class */ (function () {
    function ProductComponent(_productSerivce) {
        this._productSerivce = _productSerivce;
    ...
    ProductComponent.prototype.ngOnInit = function () {
        ...
        this._productSerivce.getProducts()
            .subscribe(function (products) { return _this.products = products; }, function (error) { return _this.errroMessage = error; });
    };
